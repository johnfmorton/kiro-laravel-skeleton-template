...
1. Clone the Repo: git clone https://github.com/johnfmorton/kiro-laravel-skeleton.git
2. (Detailed Setup Steps Coming Soon): Here we’ll outline the exact steps to get your environment running—we’ll update this part with the full details shortly.
3. Run make dev: Once everything’s set, this command will launch your local development environment.
4. Follow the Specs: Use the Kiro specs to maintain a clean and readable codebase.
